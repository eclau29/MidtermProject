...
-- Table `accessability`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `accessability` ;

CREATE TABLE IF NOT EXISTS `accessability` (
  `id` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `location` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_location_accessability_idx` (`accessability_id` ASC),
  CONSTRAINT `fk_location_accessability`
    FOREIGN KEY (`accessability_id`)
    REFERENCES `accessability` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Data for table `accessability`
-- -----------------------------------------------------
START TRANSACTION;
USE `cofishdb`;
INSERT INTO `accessability` (`id`, `name`) VALUES (1, 'Easy');
INSERT INTO `accessability` (`id`, `name`) VALUES (2, 'Medium');
INSERT INTO `accessability` (`id`, `name`) VALUES (3, 'Hard');
